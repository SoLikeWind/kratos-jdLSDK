...
var (
	ProviderSet = wire.NewSet(NewJdClient)
	CST         = time.FixedZone("CST", 8*60*60)
)

type JdLClient struct {
	config     *Config
	log        *log.Helper
...
func NewJdClient(config *Config, logger log.Logger) (*JdLClient, func(), error) {
...
// func (c *JdLClient) getMemAccessToken(ctx context.Context) (string, error) {
...
// func (c *JdLClient) getAccessToken(ctx context.Context) (string, error) {
...
// func (c *JdLClient) getTokenByCode(ctx context.Context) (string, error) {
// 	code := os.Getenv("CODE")
// 	if code == "" {
...
// func (c *JdLClient) refreshToken(ctx context.Context, appSercet string, app_key string, refresh_token string) (*GetRefreshTokenResp, error) {
...
// func (c *JdLClient) ensureToken(ctx context.Context) (*auth.Token, utils.TokenStatus, error) {
...
func (c *JdLClient) executeRequest(ctx context.Context, method, signURL string, body []byte) ([]byte, error) {
