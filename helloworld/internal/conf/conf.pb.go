...
type Bootstrap struct {
	...
	Jdl           *JdL                   `protobuf:"bytes,3,opt,name=jdl,proto3" json:"jdl,omitempty"`
...
type JdL struct {
	...
	LOP_DN        string                 `protobuf:"bytes,5,opt,name=LOP_DN,json=LOPDN,proto3" json:"LOP_DN,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *JdL) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*JdL) ProtoMessage() {}

func (x *JdL) ProtoReflect() protoreflect.Message {
	mi := &file_conf_conf_proto_msgTypes[3]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use JdL.ProtoReflect.Descriptor instead.
func (*JdL) Descriptor() ([]byte, []int) {
	return file_conf_conf_proto_rawDescGZIP(), []int{3}
}

func (x *JdL) GetEnv() string {
	if x != nil {
		return x.Env
	}
	return ""
...
func (x *JdL) GetAppSecret() string {
	if x != nil {
		return x.AppSecret
	}
	return ""
...
func (x *JdL) GetAccessToken() string {
	if x != nil {
...
const file_conf_conf_proto_rawDesc = "" +
	...
	"\x03jdl\x18\x03 \x01(\v2\x0f.kratos.api.JdLR\x03jdl\"\xb8\x02\n" +
	"\x06Server\x12+\n" +
	...
	"\n" +
	"app_secret\x18\x03 \x01(\tR\tappSecret\x12!\n" +
	"\faccess_token\x18\x04 \x01(\tR\vaccessToken\x12\x15\n" +
	"\x06LOP_DN\x18\x05 \x01(\tR\x05LOPDNB\x1fZ\x1dhelloworld/internal/conf;confb\x06proto3"
...
var file_conf_conf_proto_depIdxs = []int32{
	...
	3,  // 2: kratos.api.Bootstrap.jdl:type_name -> kratos.api.JdL
